...
import { Lock, Mail, User, Activity, ArrowRight, Loader2, Globe } from 'lucide-react';
...
const Auth: React.FC<AuthProps> = ({ onLogin, onPublicView }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4">
      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden mb-6">
          <div className="p-8">
        ...
        <button 
          ...
          className="w-full flex items-center justify-center gap-2 text-slate-400 hover:text-slate-200 transition-colors text-sm py-2"
        >
          <Globe size={16} />
